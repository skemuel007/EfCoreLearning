...
IF DB_ID('eshop') IS NULL
BEGIN
        CREATE DATABASE eshop;
END
GO

-- Switch context to eshop (so nothing goes into master)
USE eshop;
GO
...
INSERT INTO orders ( customerID, orderDate, shipAmount, taxAmount, shipDate, shipAddressID, cardType, cardNumber, cardExpires, billingAddressID) VALUES
                                                                                                                                                     ( 1, '2022-01-31 09:40:28', '5.00', '32.32', '2022-02-03 09:43:13', 1, 'v', '4111111111111111', '04/2022', 2),
                                                                                                                                                     ( 2, '2022-02-01 11:23:20', '5.00', '0.00', NULL, 3, 'v', '4111111111111111', '08/2025', 4),
                                                                                                                                                     ( 1, '2022-02-03 09:44:58', '10.00', '89.92', NULL, 1, 'm', '4111111111111111', '04/2026', 2);
